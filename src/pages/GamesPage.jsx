...
function GamesPage({ setActivePage, setCurrentGame, isMobile, currentUser, onSignIn }) {
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: isMobile ? "60px 16px 80px" : "80px 24px 40px" }}>
      ...
      {/* ── Game Discovery Card ── */}
      {!currentUser ? (
        <PixelCornerBox size="lg" borderColor={C.goldBorder} bgStyle={"color-mix(in srgb, " + C.gold + " 18%, #0a0c10)"} style={{ marginBottom: 32, padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          <div>
        ...
        <PixelCornerBox size="lg" borderColor={C.goldBorder} bgStyle={"color-mix(in srgb, " + C.gold + " 18%, #0a0c10)"} style={{ marginBottom: 32 }}>
          {/* Card header */}
