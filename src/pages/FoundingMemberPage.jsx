    ...
    <div style={{ minHeight: "100vh", paddingTop: 60, background: C.bg }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: isMobile ? "40px 16px 48px" : "64px 24px 72px", textAlign: "center", position: "relative" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: C.goldGlow, border: "1px solid " + C.goldBorder, borderRadius: 4, padding: "6px 16px", marginBottom: 24 }}>
          ...
          <button onClick={() => onSignUp?.()} style={{ background: "linear-gradient(135deg, " + C.gold + ", #d97706)", border: "none", borderRadius: 4, padding: "14px 40px", color: "#000", fontSize: 15, fontWeight: 900, cursor: "pointer", boxShadow: "0 8px 32px " + C.gold + "44" }}>Join Free</button>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: isMobile ? "40px 16px 80px" : "64px 24px 80px" }}>
        ...
        <div style={{ marginBottom: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: 20, marginBottom: 48 }}>
            {rings.map((ring, i) => (
              <PixelCornerBox key={i} size="lg" borderColor={ring.color + "44"} bg={C.surface} style={{ padding: 28 }}>
                ...
                <div style={{ background: ring.color + "0d", border: "1px solid " + ring.color + "33", borderRadius: 3, padding: "10px 14px" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: isMobile ? "48px 16px" : "72px 24px", position: "relative" }}>
          ...
          <div style={{ borderTop: "1px solid " + C.goldBorder + "66", paddingTop: 24 }}>
            ...
            <button onClick={() => { window.scrollTo(0, 0); setActivePage?.("privacy"); window.history.pushState({ page: "privacy" }, "", "/privacy"); }} style={{ background: "none", border: "1px solid " + C.goldBorder, borderRadius: 3, padding: "8px 20px", color: C.gold, fontSize: 13, fontWeight: 700, cursor: "pointer" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: isMobile ? "40px 16px 80px" : "64px 24px 80px" }}>
        <PixelCornerBox size="lg" borderColor={C.goldBorder} bgStyle={"linear-gradient(135deg, #0f0a00, #1f1500)"} style={{ padding: isMobile ? 24 : 36, textAlign: "center" }}>
          ...
          <button onClick={() => onSignUp?.()} style={{ background: "linear-gradient(135deg, " + C.gold + ", #d97706)", border: "none", borderRadius: 3, padding: "12px 36px", color: "#000", fontSize: 14, fontWeight: 900, cursor: "pointer" }}>
            Join GuildLink Free
          </button>
        </PixelCornerBox>
      </div>
