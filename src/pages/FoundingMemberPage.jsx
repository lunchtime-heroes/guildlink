  ...
  return (
    <div style={{ minHeight: "100vh", paddingTop: 60, background: C.bg }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: isMobile ? "40px 16px 48px" : "64px 24px 72px", textAlign: "center", position: "relative" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
            <GameTag label="ABOUT GUILDLINK" variant="gold" size="md" />
          </div>
          ...
          <PixelButton size="md" bg={"linear-gradient(135deg, " + C.gold + ", #d97706)"} color="#000" style={{ fontWeight: 900, fontSize: 15, padding: "14px 40px", boxShadow: "0 8px 32px " + C.gold + "44" }} onClick={() => onSignUp?.()}>Join Free</PixelButton>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: isMobile ? "40px 16px 80px" : "64px 24px 80px" }}>
        ...
        {/* Profile rings */}
        <PixelCornerBox size="lg" borderColor={C.goldBorder} bg={C.surface} style={{ marginBottom: 64 }}>
        ...
        <div style={{ marginBottom: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: 20, marginBottom: 48, alignItems: "stretch" }}>
            {rings.map((ring, i) => (
              <PixelCornerBox key={i} size="lg" borderColor={ring.color + "44"} bg={C.surface} style={{ padding: 28, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: isMobile ? "48px 16px" : "72px 24px", position: "relative" }}>
          <div style={{ display: "inline-flex", marginBottom: 24 }}>
            <GameTag label="TRANSPARENCY" variant="gold" size="md" />
          </div>
          ...
          <div style={{ borderTop: "1px solid " + C.goldBorder + "66", paddingTop: 24 }}>
            ...
            <PixelButton size="sm" bg="transparent" borderColor={C.goldBorder} color={C.gold} onClick={() => { window.scrollTo(0, 0); setActivePage?.("privacy"); window.history.pushState({ page: "privacy" }, "", "/privacy"); }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: isMobile ? "40px 16px 80px" : "64px 24px 80px" }}>
        <PixelCornerBox size="lg" borderColor={C.goldBorder} bgStyle="linear-gradient(135deg, #0f0a00, #1f1500)" style={{ padding: isMobile ? 24 : 36, textAlign: "center" }}>
          ...
          <PixelButton size="md" bg={"linear-gradient(135deg, " + C.gold + ", #d97706)"} color="#000" style={{ fontWeight: 900, fontSize: 14, padding: "12px 36px" }} onClick={() => onSignUp?.()}>Join GuildLink Free</PixelButton>
        </PixelCornerBox>
      </div>
